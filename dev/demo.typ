...
#set par(leading: 0.5em)
#text(fill: rgb(76, 86, 106), style: "italic")[#raw("# Fibonacci sequence")] \
#text(fill: rgb(191, 97, 106), weight: "bold")[#raw("function")]#raw(" ")#text(fill: rgb(129, 161, 193), weight: "bold", style: "italic")[#raw("fib")]#text(fill: rgb(229, 233, 240))[#raw("(")]#text(fill: rgb(229, 233, 240))[#raw("n")]#text(fill: rgb(229, 233, 240))[#raw("::")]#underline[#text(fill: rgb(136, 192, 208))[#raw("Int")]]#text(fill: rgb(229, 233, 240))[#raw(")")] \
#raw("    ")#text(fill: rgb(229, 233, 240))[#raw("n")]#raw(" ")#text(fill: rgb(229, 233, 240))[#raw("<=")]#raw(" ")#text(fill: rgb(235, 203, 139))[#raw("1")]#raw(" ")#text(fill: rgb(229, 233, 240))[#raw("&&")]#raw(" ")#text(fill: rgb(191, 97, 106), weight: "bold")[#raw("return")]#raw(" ")#text(fill: rgb(229, 233, 240))[#raw("n")] \
#raw("    ")#text(fill: rgb(191, 97, 106), weight: "bold")[#raw("return")]#raw(" ")#text(fill: rgb(129, 161, 193), weight: "bold", style: "italic")[#raw("fib")]#text(fill: rgb(229, 233, 240))[#raw("(")]#text(fill: rgb(229, 233, 240))[#raw("n")]#raw(" ")#text(fill: rgb(229, 233, 240))[#raw("-")]#raw(" ")#text(fill: rgb(235, 203, 139))[#raw("1")]#text(fill: rgb(229, 233, 240))[#raw(")")]#raw(" ")#text(fill: rgb(229, 233, 240))[#raw("+")]#raw(" ")#text(fill: rgb(129, 161, 193), weight: "bold", style: "italic")[#raw("fib")]#text(fill: rgb(229, 233, 240))[#raw("(")]#text(fill: rgb(229, 233, 240))[#raw("n")]#raw(" ")#text(fill: rgb(229, 233, 240))[#raw("-")]#raw(" ")#text(fill: rgb(235, 203, 139))[#raw("2")]#text(fill: rgb(229, 233, 240))[#raw(")")] \
#text(fill: rgb(191, 97, 106), weight: "bold")[#raw("end")] \
 \
#text(fill: rgb(129, 161, 193), weight: "bold", style: "italic")[#raw("println")]#text(fill: rgb(229, 233, 240))[#raw("(")]#text(fill: rgb(163, 190, 140))[#raw("\"fib(10) = ")]#text(fill: rgb(229, 233, 240))[#raw("$")]#text(fill: rgb(229, 233, 240))[#raw("(")]#text(fill: rgb(129, 161, 193), weight: "bold", style: "italic")[#raw("fib")]#text(fill: rgb(229, 233, 240))[#raw("(")]#text(fill: rgb(235, 203, 139))[#raw("10")]#text(fill: rgb(229, 233, 240))[#raw(")")]#text(fill: rgb(229, 233, 240))[#raw(")")]#text(fill: rgb(163, 190, 140))[#raw("\"")]#text(fill: rgb(229, 233, 240))[#raw(")")] \
]
]
#v(0.5em)
...
#set par(leading: 0.5em)
#text(fill: rgb(76, 86, 106), style: "italic")[#raw("# Fibonacci sequence")] \
#text(fill: rgb(191, 97, 106), weight: "bold")[#raw("def")]#raw(" ")#text(fill: rgb(129, 161, 193), weight: "bold", style: "italic")[#raw("fib")]#raw("(")#text(fill: rgb(229, 233, 240))[#raw("n")]#raw("):") \
#raw("    ")#text(fill: rgb(191, 97, 106), weight: "bold")[#raw("if")]#raw(" ")#text(fill: rgb(229, 233, 240))[#raw("n")]#raw(" ")#text(fill: rgb(229, 233, 240))[#raw("<=")]#raw(" ")#text(fill: rgb(235, 203, 139))[#raw("1")]#raw(":") \
#raw("        ")#text(fill: rgb(191, 97, 106), weight: "bold")[#raw("return")]#raw(" ")#text(fill: rgb(229, 233, 240))[#raw("n")] \
#raw("    ")#text(fill: rgb(191, 97, 106), weight: "bold")[#raw("return")]#raw(" ")#text(fill: rgb(129, 161, 193), weight: "bold", style: "italic")[#raw("fib")]#raw("(")#text(fill: rgb(229, 233, 240))[#raw("n")]#raw(" ")#text(fill: rgb(229, 233, 240))[#raw("-")]#raw(" ")#text(fill: rgb(235, 203, 139))[#raw("1")]#raw(") ")#text(fill: rgb(229, 233, 240))[#raw("+")]#raw(" ")#text(fill: rgb(129, 161, 193), weight: "bold", style: "italic")[#raw("fib")]#raw("(")#text(fill: rgb(229, 233, 240))[#raw("n")]#raw(" ")#text(fill: rgb(229, 233, 240))[#raw("-")]#raw(" ")#text(fill: rgb(235, 203, 139))[#raw("2")]#raw(")") \
 \
#text(fill: rgb(129, 161, 193), weight: "bold", style: "italic")[#raw("print")]#raw("(")#text(fill: rgb(163, 190, 140))[#raw("f\"fib(10) = ")]#text(fill: rgb(229, 233, 240))[#raw("{")]#text(fill: rgb(129, 161, 193), weight: "bold", style: "italic")[#raw("fib")]#text(fill: rgb(229, 233, 240))[#raw("(")]#text(fill: rgb(235, 203, 139))[#raw("10")]#text(fill: rgb(229, 233, 240))[#raw(")")]#text(fill: rgb(229, 233, 240))[#raw("}")]#text(fill: rgb(163, 190, 140))[#raw("\"")]#raw(")") \
]
]
#v(0.5em)
...
#set par(leading: 0.5em)
#text(fill: rgb(76, 86, 106), style: "italic")[#raw("// Fibonacci sequence")] \
#text(fill: rgb(191, 97, 106), weight: "bold")[#raw("fn")]#raw(" ")#text(fill: rgb(129, 161, 193), weight: "bold", style: "italic")[#raw("fib")]#text(fill: rgb(229, 233, 240))[#raw("(")]#text(fill: rgb(229, 233, 240))[#raw("n")]#text(fill: rgb(229, 233, 240))[#raw(":")]#raw(" ")#underline[#text(fill: rgb(143, 188, 187))[#raw("u32")]]#text(fill: rgb(229, 233, 240))[#raw(")")]#raw(" -> ")#underline[#text(fill: rgb(143, 188, 187))[#raw("u32")]]#raw(" ")#text(fill: rgb(229, 233, 240))[#raw("{")] \
#raw("    ")#text(fill: rgb(191, 97, 106), weight: "bold")[#raw("if")]#raw(" n <= ")#text(fill: rgb(235, 203, 139))[#raw("1")]#raw(" ")#text(fill: rgb(229, 233, 240))[#raw("{")]#raw(" ")#text(fill: rgb(191, 97, 106), weight: "bold")[#raw("return")]#raw(" n")#text(fill: rgb(229, 233, 240))[#raw(";")]#raw(" ")#text(fill: rgb(229, 233, 240))[#raw("}")] \
#raw("    ")#text(fill: rgb(129, 161, 193), weight: "bold", style: "italic")[#raw("fib")]#text(fill: rgb(229, 233, 240))[#raw("(")]#raw("n - ")#text(fill: rgb(235, 203, 139))[#raw("1")]#text(fill: rgb(229, 233, 240))[#raw(")")]#raw(" + ")#text(fill: rgb(129, 161, 193), weight: "bold", style: "italic")[#raw("fib")]#text(fill: rgb(229, 233, 240))[#raw("(")]#raw("n - ")#text(fill: rgb(235, 203, 139))[#raw("2")]#text(fill: rgb(229, 233, 240))[#raw(")")] \
#text(fill: rgb(229, 233, 240))[#raw("}")] \
 \
#text(fill: rgb(191, 97, 106), weight: "bold")[#raw("fn")]#raw(" ")#text(fill: rgb(129, 161, 193), weight: "bold", style: "italic")[#raw("main")]#text(fill: rgb(229, 233, 240))[#raw("(")]#text(fill: rgb(229, 233, 240))[#raw(")")]#raw(" ")#text(fill: rgb(229, 233, 240))[#raw("{")] \
#raw("    ")#text(fill: rgb(180, 142, 173), weight: "bold", style: "italic")[#raw("println")]#text(fill: rgb(180, 142, 173), weight: "bold", style: "italic")[#raw("!")]#text(fill: rgb(229, 233, 240))[#raw("(")]#text(fill: rgb(163, 190, 140))[#raw("\"fib(10) = {}\"")]#text(fill: rgb(229, 233, 240))[#raw(",")]#raw(" fib")#text(fill: rgb(229, 233, 240))[#raw("(")]#text(fill: rgb(235, 203, 139))[#raw("10")]#text(fill: rgb(229, 233, 240))[#raw(")")]#text(fill: rgb(229, 233, 240))[#raw(")")]#text(fill: rgb(229, 233, 240))[#raw(";")] \
#text(fill: rgb(229, 233, 240))[#raw("}")] \
]
]
#v(0.5em)
...
#set par(leading: 0.5em)
#text(fill: rgb(146, 131, 116), style: "italic")[#raw("# Fibonacci sequence")] \
#text(fill: rgb(204, 36, 29), weight: "bold")[#raw("function")]#raw(" ")#text(fill: rgb(69, 133, 136), weight: "bold", style: "italic")[#raw("fib")]#text(fill: rgb(168, 153, 132))[#raw("(")]#text(fill: rgb(168, 153, 132))[#raw("n")]#text(fill: rgb(168, 153, 132))[#raw("::")]#underline[#text(fill: rgb(104, 157, 106))[#raw("Int")]]#text(fill: rgb(168, 153, 132))[#raw(")")] \
#raw("    ")#text(fill: rgb(168, 153, 132))[#raw("n")]#raw(" ")#text(fill: rgb(168, 153, 132))[#raw("<=")]#raw(" ")#text(fill: rgb(215, 153, 33))[#raw("1")]#raw(" ")#text(fill: rgb(168, 153, 132))[#raw("&&")]#raw(" ")#text(fill: rgb(204, 36, 29), weight: "bold")[#raw("return")]#raw(" ")#text(fill: rgb(168, 153, 132))[#raw("n")] \
#raw("    ")#text(fill: rgb(204, 36, 29), weight: "bold")[#raw("return")]#raw(" ")#text(fill: rgb(69, 133, 136), weight: "bold", style: "italic")[#raw("fib")]#text(fill: rgb(168, 153, 132))[#raw("(")]#text(fill: rgb(168, 153, 132))[#raw("n")]#raw(" ")#text(fill: rgb(168, 153, 132))[#raw("-")]#raw(" ")#text(fill: rgb(215, 153, 33))[#raw("1")]#text(fill: rgb(168, 153, 132))[#raw(")")]#raw(" ")#text(fill: rgb(168, 153, 132))[#raw("+")]#raw(" ")#text(fill: rgb(69, 133, 136), weight: "bold", style: "italic")[#raw("fib")]#text(fill: rgb(168, 153, 132))[#raw("(")]#text(fill: rgb(168, 153, 132))[#raw("n")]#raw(" ")#text(fill: rgb(168, 153, 132))[#raw("-")]#raw(" ")#text(fill: rgb(215, 153, 33))[#raw("2")]#text(fill: rgb(168, 153, 132))[#raw(")")] \
#text(fill: rgb(204, 36, 29), weight: "bold")[#raw("end")] \
 \
#text(fill: rgb(69, 133, 136), weight: "bold", style: "italic")[#raw("println")]#text(fill: rgb(168, 153, 132))[#raw("(")]#text(fill: rgb(152, 151, 26))[#raw("\"fib(10) = ")]#text(fill: rgb(168, 153, 132))[#raw("$")]#text(fill: rgb(168, 153, 132))[#raw("(")]#text(fill: rgb(69, 133, 136), weight: "bold", style: "italic")[#raw("fib")]#text(fill: rgb(168, 153, 132))[#raw("(")]#text(fill: rgb(215, 153, 33))[#raw("10")]#text(fill: rgb(168, 153, 132))[#raw(")")]#text(fill: rgb(168, 153, 132))[#raw(")")]#text(fill: rgb(152, 151, 26))[#raw("\"")]#text(fill: rgb(168, 153, 132))[#raw(")")] \
]
]
#v(0.5em)
...
#set par(leading: 0.5em)
#text(fill: rgb(146, 131, 116), style: "italic")[#raw("# Fibonacci sequence")] \
#text(fill: rgb(204, 36, 29), weight: "bold")[#raw("def")]#raw(" ")#text(fill: rgb(69, 133, 136), weight: "bold", style: "italic")[#raw("fib")]#raw("(")#text(fill: rgb(168, 153, 132))[#raw("n")]#raw("):") \
#raw("    ")#text(fill: rgb(204, 36, 29), weight: "bold")[#raw("if")]#raw(" ")#text(fill: rgb(168, 153, 132))[#raw("n")]#raw(" ")#text(fill: rgb(168, 153, 132))[#raw("<=")]#raw(" ")#text(fill: rgb(215, 153, 33))[#raw("1")]#raw(":") \
#raw("        ")#text(fill: rgb(204, 36, 29), weight: "bold")[#raw("return")]#raw(" ")#text(fill: rgb(168, 153, 132))[#raw("n")] \
#raw("    ")#text(fill: rgb(204, 36, 29), weight: "bold")[#raw("return")]#raw(" ")#text(fill: rgb(69, 133, 136), weight: "bold", style: "italic")[#raw("fib")]#raw("(")#text(fill: rgb(168, 153, 132))[#raw("n")]#raw(" ")#text(fill: rgb(168, 153, 132))[#raw("-")]#raw(" ")#text(fill: rgb(215, 153, 33))[#raw("1")]#raw(") ")#text(fill: rgb(168, 153, 132))[#raw("+")]#raw(" ")#text(fill: rgb(69, 133, 136), weight: "bold", style: "italic")[#raw("fib")]#raw("(")#text(fill: rgb(168, 153, 132))[#raw("n")]#raw(" ")#text(fill: rgb(168, 153, 132))[#raw("-")]#raw(" ")#text(fill: rgb(215, 153, 33))[#raw("2")]#raw(")") \
 \
#text(fill: rgb(69, 133, 136), weight: "bold", style: "italic")[#raw("print")]#raw("(")#text(fill: rgb(152, 151, 26))[#raw("f\"fib(10) = ")]#text(fill: rgb(168, 153, 132))[#raw("{")]#text(fill: rgb(69, 133, 136), weight: "bold", style: "italic")[#raw("fib")]#text(fill: rgb(168, 153, 132))[#raw("(")]#text(fill: rgb(215, 153, 33))[#raw("10")]#text(fill: rgb(168, 153, 132))[#raw(")")]#text(fill: rgb(168, 153, 132))[#raw("}")]#text(fill: rgb(152, 151, 26))[#raw("\"")]#raw(")") \
]
]
#v(0.5em)
...
#set par(leading: 0.5em)
#text(fill: rgb(146, 131, 116), style: "italic")[#raw("// Fibonacci sequence")] \
#text(fill: rgb(204, 36, 29), weight: "bold")[#raw("fn")]#raw(" ")#text(fill: rgb(69, 133, 136), weight: "bold", style: "italic")[#raw("fib")]#text(fill: rgb(168, 153, 132))[#raw("(")]#text(fill: rgb(168, 153, 132))[#raw("n")]#text(fill: rgb(168, 153, 132))[#raw(":")]#raw(" ")#underline[#text(fill: rgb(142, 192, 124))[#raw("u32")]]#text(fill: rgb(168, 153, 132))[#raw(")")]#raw(" -> ")#underline[#text(fill: rgb(142, 192, 124))[#raw("u32")]]#raw(" ")#text(fill: rgb(168, 153, 132))[#raw("{")] \
#raw("    ")#text(fill: rgb(204, 36, 29), weight: "bold")[#raw("if")]#raw(" n <= ")#text(fill: rgb(250, 189, 47))[#raw("1")]#raw(" ")#text(fill: rgb(168, 153, 132))[#raw("{")]#raw(" ")#text(fill: rgb(204, 36, 29), weight: "bold")[#raw("return")]#raw(" n")#text(fill: rgb(168, 153, 132))[#raw(";")]#raw(" ")#text(fill: rgb(168, 153, 132))[#raw("}")] \
#raw("    ")#text(fill: rgb(69, 133, 136), weight: "bold", style: "italic")[#raw("fib")]#text(fill: rgb(168, 153, 132))[#raw("(")]#raw("n - ")#text(fill: rgb(250, 189, 47))[#raw("1")]#text(fill: rgb(168, 153, 132))[#raw(")")]#raw(" + ")#text(fill: rgb(69, 133, 136), weight: "bold", style: "italic")[#raw("fib")]#text(fill: rgb(168, 153, 132))[#raw("(")]#raw("n - ")#text(fill: rgb(250, 189, 47))[#raw("2")]#text(fill: rgb(168, 153, 132))[#raw(")")] \
#text(fill: rgb(168, 153, 132))[#raw("}")] \
 \
#text(fill: rgb(204, 36, 29), weight: "bold")[#raw("fn")]#raw(" ")#text(fill: rgb(69, 133, 136), weight: "bold", style: "italic")[#raw("main")]#text(fill: rgb(168, 153, 132))[#raw("(")]#text(fill: rgb(168, 153, 132))[#raw(")")]#raw(" ")#text(fill: rgb(168, 153, 132))[#raw("{")] \
#raw("    ")#text(fill: rgb(177, 98, 134), weight: "bold", style: "italic")[#raw("println")]#text(fill: rgb(177, 98, 134), weight: "bold", style: "italic")[#raw("!")]#text(fill: rgb(168, 153, 132))[#raw("(")]#text(fill: rgb(152, 151, 26))[#raw("\"fib(10) = {}\"")]#text(fill: rgb(168, 153, 132))[#raw(",")]#raw(" fib")#text(fill: rgb(168, 153, 132))[#raw("(")]#text(fill: rgb(250, 189, 47))[#raw("10")]#text(fill: rgb(168, 153, 132))[#raw(")")]#text(fill: rgb(168, 153, 132))[#raw(")")]#text(fill: rgb(168, 153, 132))[#raw(";")] \
#text(fill: rgb(168, 153, 132))[#raw("}")] \
]
]
#v(0.5em)
